...
import (
	...
	"github.com/memeticofficial/coreth/peer/stats"
...
type network struct {
	...
	outstandingRequestHandlers map[uint32]message.ResponseHandler // maps pepecoingo requestID => message.ResponseHandler
	...
	appSender                  common.AppSender                   // pepecoingo AppSender for sending messages
...
// CrossChainAppRequestFailed can be called by the pepecoingo -> VM in following cases:
...
// AppGossip is called by pepecoingo -> VM when there is an incoming AppGossip from a peer
// error returned by this function is expected to be treated as fatal by the engine
